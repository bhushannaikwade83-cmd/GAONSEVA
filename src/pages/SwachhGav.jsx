        ...
        <Stack direction="row" alignItems="center" justifyContent="space-between" sx={{ flexWrap: 'wrap', gap: 2 }}>
          <Box>
            <Typography variant="h5" sx={{ 
              ...
              स्वच्छ गाव फोटो गॅलरी
            </Typography>
            <Box sx={{ width: '80px', height: '4px', background: '#FFD700', borderRadius: '2px', mb: 1 }} />
            <Typography variant="body1" sx={{ 
              color: '#FFFFFF',
              fontFamily: '"Roboto", "Arial", sans-serif',
              textShadow: '1px 1px 2px rgba(0,0,0,0.3)'
            }}>
              ग्रामपंचायत स्वच्छता उपक्रमांचे क्षणचित्र
            </Typography>
          </Box>
          <Chip 
            label={`${images.length} फोटो`} 
            sx={{ 
