  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-50 p-4 md:p-8">
      <div className="max-w-7xl mx-auto">
        {/* Header */}
          <div className="bg-white rounded-lg shadow-lg p-6 mb-6 border-t-4 border-blue-800" style={{ borderTopColor: '#1976d2' }}>
          <h1 className="text-3xl md:text-4xl font-bold mb-2" style={{ color: '#1976d2', fontFamily: '"Roboto", "Arial", sans-serif' }}>
            अर्थसंकल्प आणि पारदर्शकता
          </h1>
          <div className="w-20 h-1 bg-yellow-500 mb-3" style={{ backgroundColor: '#FFD700' }}></div>
          <p className="text-gray-700" style={{ fontFamily: '"Roboto", "Arial", sans-serif' }}>
